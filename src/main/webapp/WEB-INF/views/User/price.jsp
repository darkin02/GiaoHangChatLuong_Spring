...
<div class="jumbotron jumbotron-fluid mb-5">
    <div class="container text-center py-5">
        <h1 class="text-white display-3">Giá</h1>
    </div>
</div>
<!-- Header End -->
<!-- Pricing Plan Start -->
<div class="container-fluid pt-5">
    <div class="container">
        <div class="text-center pb-2">
            <h6 class="text-primary text-uppercase font-weight-bold">Giá Gói</h6>
            <h1 class="mb-4">Giá gói cả phải chăng</h1>
        </div>
        <div class="row">
                ...
                <div class="bg-secondary">
                    <div class="text-center p-4">
                        <h1 class="display-4 mb-0">
                            <small class="align-top text-muted font-weight-medium" style="font-size: 22px; line-height: 45px;"></small>12.000đ<small class="align-bottom text-muted font-weight-medium" style="font-size: 16px; line-height: 40px;">/1kg&100km</small>
                        </h1>
                    </div>
                    <div class="bg-primary text-center p-4">
                        <i class="fa fa-2x fa-plane text-dark pr-3"></i>
                        <h3 class="m-0">Hàng Không</h3>
                    </div>
                    <div class="d-flex flex-column align-items-center py-4">

                        <a href="" class="btn btn-primary py-2 px-4 my-2">Gửi ngay</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-5">
                <div class="bg-secondary">
                    <div class="text-center p-4">
                        <h1 class="display-4 mb-0">
                            <small class="align-top text-muted font-weight-medium" style="font-size: 22px; line-height: 45px;"></small>10.000đ<small class="align-bottom text-muted font-weight-medium" style="font-size: 16px; line-height: 40px;">/1kg&100km</small>
                        </h1>
                    </div>
                    <div class="bg-primary text-center p-4">
                        <i class="fa fa-2x fa-ship text-dark pr-3"></i>
                        <h3 class="m-0">Đường Thủy</h3>
                    </div>
                    <div class="d-flex flex-column align-items-center py-4">
